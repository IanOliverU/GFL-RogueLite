...
M1 uses system fonts and no downloaded assets, Blender exports, generated raster art or audio. Blender tools were listed in the environment but no connection or scene was needed or tested. There are no editable art-source/runtime-export files yet; procedural sources above are the editable assets. The later checkpoint kit below remains unimplemented.
